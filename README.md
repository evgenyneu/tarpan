...
* **R_hat** is a Stan's parameter representing the quality of the sampling. We need this to be near 1. After generating a model I usually immediately look at this R_hat column to see if I had good sampling.
