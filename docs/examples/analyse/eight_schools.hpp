...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/Users/evgenii/code/python/libraries/tarpan/docs/examples/analyse/eight_schools.stan");
    reader.add_event(20, 18, "end", "/Users/evgenii/code/python/libraries/tarpan/docs/examples/analyse/eight_schools.stan");
    return reader;
}

class eight_schools_model
  : public stan::model::model_base_crtp<eight_schools_model> {
private:
        int J;
        std::vector<double> y;
